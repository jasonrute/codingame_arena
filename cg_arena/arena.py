...
class Arena:
    ...
    def __init__(self, argv):
        ...
        self.play_single_game = False
        self.play_double_game = False
        ...
        for opt, arg in opts:
            if opt == '-t': # Turn on time limits
                ...
                if self.play_double_game:
                    print("Can't play a single and a double game.")
                    sys.exit(2)
                self.play_single_game = True
                self.config_str = arg
    ...
    def run(self):
        ...
        if self.play_single_game or self.play_double_game:
            self.verbose = True
            ...
            program_names = self.player_list
